...
void bench_invidx(std::string input_prefix,std::string collection_dir)
{
    ...
    std::uniform_int_distribution<> dis(0, invidx_loaded.num_lists()-1);
...
int main(int argc, const char* argv[])
{
    ...
    
    {
        ...
        bench_invidx<doc_list_type,freq_list_type>(args.input_prefix,args.collection_dir+"-"+doc_list_type::name());
    }
    {
