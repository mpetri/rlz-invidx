...
public:
    static sdsl::int_vector<8>
    dictionary_creation_strategy::create(std::string input_file,size_t dict_size_bytes);
    {
        ...
        LOG(INFO) << "\tinput epoch size = " << sample_step;
